<?php
/*
 Plugin Name: WNode HTML Generation
 Plugin URI: https://wnode.mgvmedia.com
 Description: WNode is a small and fast PHP library, allowing easy, valid (X)HTML generation within PHP code.
...
if (defined('WNODE_SHORT_FUNCTION_ACCESS') && WNODE_SHORT_FUNCTION_ACCESS && !function_exists('wn')) {
	function wn($elementName, $content = null) {
		return WNode::get($elementName, $content);
	}
}

endif; // class_exists condition
?>
